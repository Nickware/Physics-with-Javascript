// 1. 3-Layer Canvas Configuration:
// - canvas_bg: Sky (blue→white gradient)
// - canvas_fg: Interface/Sea (semi-transparent overlay)
// - canvas: Submarine and Main Animation
// 2. Physical Parameters (gravity, density, volume)
// 3. Submarine Model (mass, ballast, geometry)
// 4. Animation Loop with Force Integration
// 5. User Controls: Horizontal Thrust + Ballast Adjustment
